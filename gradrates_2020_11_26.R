...
ggplot(data = data.frame(x = 0), mapping = aes(x = x)) + 
  stat_function(fun = wd.f, color = "red", linetype = 1, size=1.2) + 
  annotate(geom = "text", x=0.3, y=3.8, label = expression("w"^"d"), color = "red", size=8) +
  stat_function(fun = ld.f, color = "black", linetype = 1, size=1.2) +
  annotate(geom = "text", x=0.3, y=1.8, label = expression("L"^"d"), color = "black", size=8) +
  stat_function(fun = ln.f, color = "blue", linetype = 1, size=1.2) +
  annotate(geom = "text", x=0.3, y=7.5, label = expression("L"^"n"), color = "blue", size=8) +
